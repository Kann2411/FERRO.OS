...
export function AmbientBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(217,4,41,0.16),transparent_34%),linear-gradient(135deg,rgba(20,20,20,0.95),rgba(9,9,9,0.98))]">
      <motion.div
